...
export const homeScripts = [
  ...
  {
    "id": "nav-logo-footer-tracking",
    "content": "(function() {\n  var tries = 0;\n  function initLogoTracking() {\n    var logo = document.querySelector('.navbar_logo-wrapper');\n    var footer = document.querySelector('footer.footer');\n    if (!logo || !footer || logo.dataset.trackingBound) return;\n    logo.dataset.trackingBound = 'true';\n    gsap.registerPlugin(ScrollTrigger);\n    var mm = gsap.matchMedia();\n    mm.add('(min-width: 768px)', function() {\n      gsap.to(logo, {\n        x: function() {\n          var currentX = gsap.getProperty(logo, 'x') || 0;\n          var r = logo.getBoundingClientRect();\n          var naturalCentre = r.left - currentX + r.width / 2;\n          return (window.innerWidth / 2) - naturalCentre;\n        },\n        y: function() { return window.innerHeight * 0.22; },\n        scale: 0.55,\n        opacity: 0,\n        ease: 'none',\n        scrollTrigger: {\n          trigger: footer,\n          start: 'top bottom',\n          end: 'top 45%',\n          scrub: true,\n          invalidateOnRefresh: true\n        }\n      });\n    });\n  }\n  function waitForGsap() {\n    if (window.gsap && window.ScrollTrigger) { initLogoTracking(); return; }\n    if (tries++ < 40) setTimeout(waitForGsap, 100);\n  }\n  if (document.readyState === 'loading') {\n    window.addEventListener('DOMContentLoaded', waitForGsap);\n  } else {\n    waitForGsap();\n  }\n})();",
    "strategy": "afterInteractive"
  }
];
